    ...
    F.prototype.config = {
        ...
        if (i.startTime = (new Date).getTime(), a.url) {
            ...
            a.contentType && 0 == a.contentType.indexOf("application/json") && (d = JSON.stringify(d)), t.ajax({
                ...
                error: function (e, t) {
                    var errorMsg = !e.responseJSON?t:!e.responseJSON.message?t:e.responseJSON.message;
                    i.layMain.html('<div class="' + f + '">数据接口请求异常：' + errorMsg + "</div>"),"function" == typeof a.error&&a.error(e.responseText),i.renderForm(), i.setColsWidth()
                    ...
                    s({
                        list: function () {
                            ...
                            n.on("checkbox(LAY_TABLE_TOOL_COLS)", function (e) {
                                ...
                                if (layui.soulTable) { layui.soulTable.fixTableRemember(a.config, s)}   //这是要添加的那一行
                            })
                        }
                    });
                    break;
